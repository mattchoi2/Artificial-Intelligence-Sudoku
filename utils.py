...
def distance(a, b):
    ...
    # hA is current, hB is the goal node
    # xA and xB lat # yA and yB long
    xA, yA, hA = a
    xB, yB, hB = b
    R = 3958.8
    ...
    # Make sure to convert the elevation change (in meters) to miles
    elevationChange = abs((hA - hB) / 1000) # into kilometers
    elevationChange = elevationChange * 0.62137 # into miles
    return hypot(d, elevationChange) # Combines both the DISTANCE and ELEVATION change in the heuristic
